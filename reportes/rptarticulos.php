...
$pdf->Cell(30,6,utf8_decode('Descripción'),1,0,'C',1);
...
$pdf->SetWidths(array(48,40,25,12,30,30));
...
{  
    ...
    $pdf->Row(array(utf8_decode($nombre),utf8_decode($categoria),$codigo,$stock,utf8_decode($marca),utf8_decode($descripcion)));
}
