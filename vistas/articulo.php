                  ...
                  <div class="box">
                    ...
                    <div class="panel-body" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Marca(*):</label>
                            <input type="text" class="form-control" name="marca" id="marca" maxlength="100" placeholder="Ej: Samsung, Apple, HP..." required>
                          </div>
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Tipo de Pantalla:</label>
                            <select class="form-control selectpicker" name="tipo_pantalla" id="tipo_pantalla" data-live-search="true"></select>
                          </div>
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Imagen:</label>
