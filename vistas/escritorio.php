...
if ($_SESSION['escritorio']==1)
{
  ...
  $totalc=$regc->total_compra ? $regc->total_compra : 0;

  $rsptav = $consulta->totalventahoy();
  $regv=$rsptav->fetch_object();
  $totalv=$regv->total_venta ? $regv->total_venta : 0;
                    ...
                    <div class="panel-body">
                          ...
                          <div class="small-box bg-aqua">
                              <div class="inner">
                                <h4 style="font-size:17px;">
                                  <strong>S/ <?php echo number_format($totalc, 0, '.', ','); ?></strong>
                                </h4>
                                <p>Compras de Hoy</p>
                              </div>
                              <div class="icon">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                          <div class="small-box bg-green">
                              <div class="inner">
                                <h4 style="font-size:17px;">
                                  <strong>S/ <?php echo number_format($totalv, 0, '.', ','); ?></strong>
                                </h4>
                                <p>Ventas de Hoy</p>
                              </div>
                              <div class="icon">
