...
<html>
  <head>
    ...
    <title>Bugs - Panel de Administración</title>
    ...
    <!-- Dashboard Profesional Gaming -->
    <link rel="stylesheet" href="../public2/dashboard-pro.css?v=2.0">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="escritorio.php" class="logo">
          ...
          <span class="logo-mini"><b>B</b>ugs</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><i class="fa fa-bug"></i> <b>Bugs</b></span>
        </a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      <?php echo $_SESSION['nombre']; ?><?php echo isset($_SESSION['cargo']) && !empty($_SESSION['cargo']) ? ' - ' . $_SESSION['cargo'] : ''; ?>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">       
          ...
          <ul class="sidebar-menu">
            ...
            <?php 
              if (isset($_SESSION['bancos']) && $_SESSION['bancos']==1)
              {
                echo '<li id="mBancos" class="treeview">
                <a href="#">
                ...
                <ul class="treeview-menu">
                  <li id="lBancos"><a href="banco.php"><i class="fa fa-circle-o"></i> Bancos</a></li>
                </ul>
              </li>'; 
              }
            ?>
